...
@Component({
  ...
  imports: [
    ReactiveFormsModule,
    CommonModule,
    ToastModule,          // ✅ Needed for <p-toast>
    ConfirmDialogModule   // ✅ Needed for <p-confirmDialog>
  ],
...
export class SalaryStructureComponent implements OnInit {
  ...
  fetchSalaryStructureByEmpId() {
    ...
    this.authService.getSalaryStructureById(empId).subscribe({
      ...
      error: () => {
        this.messageService.add({ severity: 'error', summary: 'Error', detail: ' fetch salary structure.' });
      }
    });
  }
  ...
  updateSalaryStructure() {
    ...
    this.authService.updateSalaryStructure(id, payload).subscribe({
      ...
      error: () => {
        this.messageService.add({ severity: 'error', summary: 'Error', detail: ' update salary structure.' });
      }
    });
  }
  ...
  deleteSalaryStructure() {
    ...
    this.authService.deleteSalaryStructure(id).subscribe({
      ...
      error: () => {
        this.messageService.add({ severity: 'error', summary: 'Error', detail: ' delete salary structure.' });
      }
    });
  }
